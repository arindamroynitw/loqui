...
//  Loqui
//
//  Groq API client for LLM-based transcript cleanup
//

import Foundation

/// Groq API client for fast cloud-based LLM inference
@MainActor
class GroqClient {
    // MARK: - Properties
    ...
    func cleanTranscript(_ rawText: String) async throws -> String {
        print("🌐 GroqClient: Cleaning '\(rawText)'")
        ...
        do {
            ...
            print("✅ GroqClient: '\(rawText)' → '\(cleanedText)'")
